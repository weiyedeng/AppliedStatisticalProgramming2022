...
\begin{enumerate}
  \item Build the Rcpp code described below. Be sure to provide many comments in your code blocks to facilitate grading. Undocumented code will not be graded.
...
\begin{enumerate}
   ...
   \item Write a development .R file that demonstrates their use.
\end{enumerate}
